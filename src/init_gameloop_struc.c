...
gameloop_t init_gameloop_struct(void)
{
    ...
    gameloop.scale.x = 1;
    gameloop.scale.y = 1;
    gameloop.background_texture = sfTexture_createFromFile(
            "ressources/background.png", NULL);
    gameloop.fire_entities_1 = sfTexture_createFromFile(
            "ressources/fire_ball_1.png", NULL);
...
{
    gameloop.fire_entities_2 = sfTexture_createFromFile(
            "ressources/fire_ball_2.png", NULL);
    gameloop.fire_entities_3 = sfTexture_createFromFile(
            "ressources/fire_ball_3.png", NULL);
    gameloop.fire_entities_4 = sfTexture_createFromFile(
            "ressources/fire_ball_4.png", NULL);
    gameloop.fire_entities_5 = sfTexture_createFromFile(
            "ressources/fire_ball_5.png", NULL);
...
gameloop_t game_init_last(gameloop_t gameloop)
{
    ...
    gameloop.aim_pointer_texture = sfTexture_createFromFile(
            "ressources/aim_pointer.png", NULL);
    sfSprite_setTexture(gameloop.aim_pointer
    , gameloop.aim_pointer_texture, sfTrue);
    gameloop.scale_pointer.y = 0.1;
    gameloop.scale_pointer.x = 0.1;
    sfSprite_setScale(gameloop.aim_pointer, gameloop.scale_pointer);
    gameloop = texte_init(gameloop);
    return gameloop;
}
